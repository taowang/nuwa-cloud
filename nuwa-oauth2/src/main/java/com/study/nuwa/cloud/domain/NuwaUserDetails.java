package com.study.nuwa.cloud.domain;
 ...
 */
@Getter
public class NuwaUserDetails extends User {
	...
	public NuwaUserDetails(Long id, String tenantId, String oauthId, String nickname, String realName,
