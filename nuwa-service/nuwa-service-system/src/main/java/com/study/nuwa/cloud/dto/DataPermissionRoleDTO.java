...
@Schema(description ="DataPermissionRoleDTO对象")
public class DataPermissionRoleDTO extends BaseEntity {
    ...
    @Schema(description = "数据权限类型:1只能查看本人 2只能查看本部门 3只能查看本部门及子部门 4可以查看所有数据")
    ...
    @Schema(description = "功能权限名称")
    private String resourceName;

    @Schema(description = "功能权限类型")
