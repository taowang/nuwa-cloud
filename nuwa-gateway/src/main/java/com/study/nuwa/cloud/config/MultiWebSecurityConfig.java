...
import com.study.nuwa.cloud.auth.AuthorizationManager;
import com.study.nuwa.cloud.component.AuthServerAccessDeniedHandler;
import com.study.nuwa.cloud.component.AuthServerAuthenticationEntryPoint;
import com.study.nuwa.cloud.filter.WhiteListRemoveJwtFilter;
...
public class MultiWebSecurityConfig {
    ...
    @Autowired
    public MultiWebSecurityConfig(AuthorizationManager authorizationManager,
                                  AuthServerAccessDeniedHandler authServerAccessDeniedHandler,
                                  AuthServerAuthenticationEntryPoint authServerAuthenticationEntryPoint,
                                  AuthUrlWhiteListProperties authUrlWhiteListProperties,
                                  WhiteListRemoveJwtFilter whiteListRemoveJwtFilter,
                                  SecurityProperties securityProperties) {
        this.authorizationManager = authorizationManager;
        this.authServerAccessDeniedHandler = authServerAccessDeniedHandler;
        this.authServerAuthenticationEntryPoint = authServerAuthenticationEntryPoint;
